...
$selectedcontroller=GetIntFromRequest("selectedcontroller");//getselectedcontrollerfromrequest();
...
$cmd = $MEGACLI." -AdpEventLog -GetEvents -f $TMPEVENTLOG -a".$selectedcontroller." -NoLog";
